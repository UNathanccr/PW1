        ...
        */
        if (user_input == username && pass_input == password) {
            Swal.fire({
                ...
                timer: 5000,
                html: '<iframe src="https://lottie.host/embed/015299ce-2207-40a9-9770-61c03c33c0f5/lQJGTSxqe7.lottie" frameborder="0"></iframe> <br><br><p>Esperar un momento...</p>',               
            }).then(() => {
                /* redirección a una pagina web llamada landing.html */ 
                window.location.href = "landing.html", "blank"; 
            });
            /*si el usuario y la contraseña no coinciden, se asigna el mensaje "Usuario o contraseña incorrecta." a la variable text.
